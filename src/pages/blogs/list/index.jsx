...
import { count, search, remove, getCategory, getLoggedInUser } from '../service';
  ...
  const columns = [
    {
      ...
      render: (dom, entity) => {
        return (
          <a
            onClick={() => {
              history.push(`/blogs/edit/${entity._id}`);
            }}
          >
            {dom}
          </a>
      ...
      },
    {
      title: 'Meta Tags',
      dataIndex: 'meta_tag',
      render:(meta_tag)=>meta_tag + " "
    },
        {
      title: 'Meta Description',
      dataIndex: 'meta_description',
      render:(metaDescription)=>metaDescription + " "
    },
    {
      title: 'Updated At',
      dataIndex: 'updatedAt',
